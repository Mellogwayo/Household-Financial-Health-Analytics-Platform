...
```{r Initial Data Preparation, eval = FALSE, echo=FALSE}
...
```{r Distribution of Sample Members by Country, echo=FALSE}
...
```{r Distribution of Members by Region, echo=FALSE}
# Calculate percentages
data_percentage <- data %>%
  count(jkl_gor_dv) %>%
  mutate(percentage = n / sum(n) * 100)
...
```{r Employment Status Distribution, echo=FALSE}
...
```{r Housing Tenure of Respondents, echo=FALSE}
# Calculate percentages
data_percentage <- data %>%
  count(jkl_tenure_dv) %>%
  mutate(percentage = n / sum(n) * 100)
...
```{r Scatter plot: Household Income vs Employment Status, colored by Region, echo=FALSE}
# Scatter plot: Household Income vs Employment Status, colored by Region
ggplot(data, aes(x = jkl_jbstat, y = jkl_fihhmnnet1_dv, color = jkl_gor_dv)) +
  geom_point(alpha = 0.6) +  # Add transparency for better visualization
  labs(
    title = "Household Income vs. Employment Status",
    x = "Employment Status",
    y = "Household Income",
    color = "Region"
  ) +
...
```{r Numerical Variables: Income Distributions, echo=FALSE}
...
```{r Calculating Correlation, echo=FALSE}
...
```{r Employment Status Categories, echo=FALSE}
...
```{r Classification of current job eight-class model, echo=FALSE}
# Filter out the 'inapplicable' category
filtered_data1 <- data %>%
...
```{r Classification of an individuals current job five-class model, echo=FALSE}
# Filter out the 'inapplicable' category
filtered_data2 <- data %>%
...
```{r Classification of current job three-class model, echo=FALSE}
# Filter out the 'inapplicable' category
filtered_data3 <- data %>%
...
```{r Distribution of Household Sizes, echo=FALSE}
...
```{r Employment status varies accross different demographics, echo=FALSE}
...
```{r Employment Status within Regions in the UK, echo=FALSE}
...
```{r Most Common Employment Status in Each Region, echo=FALSE}
...
```{r Proportion of Ethnic Group within different Employment Status groups, echo=FALSE}
...
```{r Socio-economic Classification, echo=FALSE}
...
```{r Proportion of Current job Class status within Regions in the UK, echo=FALSE}
# Define descriptive labels for each variable
variable_labels <- list(
  "jkl_jbnssec8_dv" = "Current job: Eight Class NS-SEC status",
  "jkl_jbnssec5_dv" = "Current job: Five Class NS-SEC status",
...
```{r Map of the Proportion of Current Job Class status within Regions in the UK, echo=FALSE}
# Define descriptive labels for each variable
variable_labels <- list(
  "jkl_jbnssec8_dv" = "Current job: Eight Class NS-SEC status",
  "jkl_jbnssec5_dv" = "Current job: Five Class NS-SEC status",
...
```{r Proportion of Ethnic groups within various job class status, echo=FALSE}
...
```{r Health and Well-being, echo=FALSE}
# Define descriptive labels for each variable
variable_labels <- list(
  "jkl_health" = " Long-standing illness or disability status",
  "jkl_country" = "Country in the UK sample members currently live in",
...
```{r Proportion of Long-standing illness or disability status within Regions in the UK, echo=FALSE}
# List of key variables
...
```{r Proportion of Ethnic group within various Long-standing illness or disability status categories, echo=FALSE}
# Define descriptive labels for each variable
variable_labels <- list(
  "jkl_health" = "Long-standing illness or disability status",
  "jkl_ethn_dv" = "Ethnic group"
...
```{r Proportion of residents by region, living environment, gender, and ethnicity within different housing tenure categories, echo=FALSE}
...
```{r Proportion of various Housing Tenures within Regions in the UK, echo=FALSE}
# List of key variables
...
```{r Proportion of Housing Tenures in Different Regions in the UK, echo=FALSE}
# List of key variables
key_variables <- "jkl_tenure_dv"
...
```{r Proportion of ethnicity within different housing tenure categories, echo=FALSE}
# Define descriptive labels for each variable
variable_labels <- list(
  "jkl_tenure_dv" = "Housing Tenure",
  "jkl_ethn_dv" = "Ethnic group"
...
```{r Distribution of Net Household Monthly Income across various regions, living environments, genders, and ethnicities, echo=FALSE}
...
```{r Map of Proportion of various income Bins in Different Regions in the UK, echo=FALSE}
...
```{r Proportion of Ethnic groups within Income Bin, echo=FALSE}
# Define the numerical key variable
key_variable <- "jkl_fihhmnnet1_dv"
...
```{r Income Distribution by Employment Status in England, echo=FALSE}
...
```{r Income Distribution by Employment Status in Northern Ireland, echo=FALSE}
# Filter data 
...
```{r Income Distribution by Employment Status in Scotland, echo=FALSE}
# Filter data 
Scotland_data <- data %>%
...
```{r Income Distribution by Employment Status in Wales, echo=FALSE}
# Filter data 
Wales_data <- data %>%
...
```{r Income Distribution by Employment Status in North East, echo=FALSE}
# Filter data 
...
```{r Income Distribution by Employment Status in West Midlands, echo=FALSE}
# Filter data 
...
```{r Income Distribution by Employment Status in North West, echo=FALSE}
# Filter data 
...
```{r Income Distribution by Employment Status in Yorkshire and The Humber, echo=FALSE}
# Filter data 
...
```{r Income Distribution by Employment Status in  Scotland (Part 1), echo=FALSE}
# Filter data 
Scotland_data <- data %>%
...
```{r Income Distribution by Employment Status in  East Midlands, echo=FALSE}
# Filter data 
...
```{r Income Distribution by Employment Status in  London, echo=FALSE}
# Filter data 
London_data <- data %>%
...
```{r Income Distribution by Employment Status in  South East, echo=FALSE}
# Filter data 
...
```{r Income Distribution by Employment Status in  South West, echo=FALSE}
# Filter data 
...
```{r Income Distribution by Employment Status in  East of England, echo=FALSE}
# Filter data 
...
```{r Income Distribution for various Household Compositions, echo=FALSE}
...
```{r Income Distribution for various Socio-economic Classification, echo=FALSE}
...
```{r Income Distribution for various Health and Well-being statuses, echo=FALSE}
...
```{r Income Distribution for various Household Compositions & Sizes, echo=FALSE}
...
```{r Income Distribution for various Tenures, echo=FALSE}
# Filter out missing category for household type if needed
filtered_data <- data %>% filter(jkl_hhtype_dv != "missing")
